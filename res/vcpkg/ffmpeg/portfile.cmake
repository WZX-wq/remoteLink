...
if(VCPKG_DETECTED_CMAKE_C_COMPILER)
    ...
    if(VCPKG_HOST_IS_WINDOWS)
        if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Android")
            if(DEFINED ENV{FFMPEG_HOST_CC} AND NOT "$ENV{FFMPEG_HOST_CC}" STREQUAL "")
                set(FFMPEG_HOST_CC "$ENV{FFMPEG_HOST_CC}")
            else()
                vcpkg_find_acquire_program(CLANG)
                set(FFMPEG_HOST_CC "${CLANG}")
            endif()
            string(REPLACE "\\" "/" FFMPEG_HOST_CC "${FFMPEG_HOST_CC}")
