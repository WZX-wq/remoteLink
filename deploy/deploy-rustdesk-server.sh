...
write_compose_env() {
  ...
  if [[ "${#missing[@]}" -eq 0 ]]; then
    load_compose_env_file
    {
      ...
      printf 'KQ_DOWNLOAD_VERSION=%s\n' "${KQ_DOWNLOAD_VERSION:-2026.06.24.2020}"
      printf 'KQ_DOWNLOAD_SHA256=%s\n' "${KQ_DOWNLOAD_SHA256:-9719E18CEC4A13FF1AE7D894477DD1F9AA53C8833B77139FE2937AEA8B97C2FC}"
      ...
      printf 'KQ_ANDROID_DOWNLOAD_VERSION=%s\n' "${KQ_ANDROID_DOWNLOAD_VERSION:-1.4.6+2067}"
      printf 'KQ_ANDROID_DOWNLOAD_SHA256=%s\n' "${KQ_ANDROID_DOWNLOAD_SHA256:-62EC74E9ABE318120BED540DC0C8B67FD5BA90D2F742265D6847ED315FE03EED}"
