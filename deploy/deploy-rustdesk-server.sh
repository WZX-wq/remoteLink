...
write_compose_env() {
  ...
  if [[ "${#missing[@]}" -eq 0 ]]; then
    load_compose_env_file
    {
      ...
      printf 'KQ_ANDROID_DOWNLOAD_SHA256=%s\n' "${KQ_ANDROID_DOWNLOAD_SHA256:-BE052580AC46D27BF3A0856D586D5E793F62A8C64607B5B9DE9B2AE4E6E9582E}"
