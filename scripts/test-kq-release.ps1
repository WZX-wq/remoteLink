...
function Test-KqPasswordKindPersistence {
    ...
    if ($model -match 'kq-v234-permanent-password-autofill-on-select' -and
        $model -match '(?s)kind == KqPasswordKind\.permanent[\s\S]*_ensurePermanentPasswordPreviewOnSelect\(\)' -and
        $model -match '(?s)Future<void> _ensurePermanentPasswordPreviewOnSelect\(\)[\s\S]*_permanentPasswd\.text\.trim\(\)\.isNotEmpty[\s\S]*_localPermanentPasswordSet[\s\S]*_permanentPasswordSet[\s\S]*await setPermanentPasswordPreview\(password\)') {
        Add-Check "password:v234-permanent-autofill-on-select" "PASS" "selecting permanent password generates a first random code without overwriting existing permanent codes"
    } else {
        Add-Check "password:v234-permanent-autofill-on-select" "FAIL" "selecting permanent password does not safely generate the first random code"
    }
}
...
if (Test-Path $manifestPath) {
    ...
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "_SettingPalette" "ui:settings-reference-palette"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "pageBackground: Colors.white" "ui:settings-reference-white-page-background"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "contentBackground: Colors.white" "ui:settings-reference-white-content-background"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "sidebarBackground: Colors.white" "ui:settings-reference-white-sidebar-background"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "navSelectedBackground: Color(0xFFEAF1FF)" "ui:settings-reference-selected-nav"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "cardHeaderBackground: Colors.white" "ui:settings-reference-card-header"
    ...
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-settings-dark-reference-card-colors" "ui:v227-settings-dark-reference-card-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-settings-dark-reference-divider" "ui:v227-settings-dark-reference-divider"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-settings-choice-pill-theme-colors" "ui:v227-settings-choice-pill-theme-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-settings-access-password-dark-colors" "ui:v227-settings-access-password-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-account-reference-card-theme-colors" "ui:v227-account-reference-card-theme-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-account-remote-performance-dark-colors" "ui:v227-account-remote-performance-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v227-about-page-dark-colors" "ui:v227-about-page-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v227-home-designer-panel-theme-colors" "ui:v227-home-designer-panel-theme-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v227-home-member-banner-dark-colors" "ui:v227-home-member-banner-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v227-devices-table-dark-colors" "ui:v227-devices-table-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v227-devices-recent-card-dark-colors" "ui:v227-devices-recent-card-dark-colors"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v231-sidebar-hover-readable-colors" "ui:v231-sidebar-hover-readable-colors"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "message: widget.label" "ui:v231-sidebar-no-hover-tooltip"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v232-member-payment-method-selected-contrast" "ui:v232-member-payment-method-selected-contrast"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "Icons.check_circle_rounded" "ui:v232-member-payment-method-selected-check"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "selected ? colors.primary : colors.onSurfaceVariant" "ui:v232-member-payment-method-icon-contrast"
    Test-SourceContains ".\flutter\lib\common.dart" "String kqLocaleText({required String zhCn, required String en})" "ui:v233-locale-text-helper"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v233-desktop-home-locale-text" "ui:v233-home-locale-text-marker"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v233-desktop-account-locale-text" "ui:v233-account-locale-text-marker"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kqLocaleText(zhCn:" "ui:v233-peer-card-fallback-localized-helper"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "en: 'Remote device')" "ui:v233-peer-card-fallback-localized-en"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "label: '远程协助'" "ui:v233-home-no-bare-remote-assist-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "label: '设备'" "ui:v233-home-no-bare-devices-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "label: '我的账户'" "ui:v233-home-no-bare-account-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "label: '设置'" "ui:v233-home-no-bare-settings-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "label: '官网'" "ui:v233-home-no-bare-website-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "title: '最近连接'" "ui:v233-devices-no-bare-recent-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "title: '全部设备'" "ui:v233-devices-no-bare-all-devices-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "const Text('连接')" "ui:v233-devices-no-bare-connect-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "Text('暂无设备记录'" "ui:v233-devices-no-bare-empty-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "Text('登录鲲穹账号'" "ui:v233-account-no-bare-login-title-cn"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "label: const Text('立即登录')" "ui:v233-account-no-bare-login-action-cn"
    ...
    Test-SourceContains ".\flutter\lib\consts.dart" "kDesktopMainWindowDefaultSize = Size(1080, 720)" "ui:v221-main-window-narrow-default-size"
    Test-SourceContains ".\flutter\lib\consts.dart" "kDesktopMainWindowMinSize = Size(1072, 700)" "ui:v221-main-window-narrow-min-size"
    ...
    Test-SourceContains ".\flutter\lib\main.dart" "kq-v228-main-window-fixed-size" "ui:v228-main-window-fixed-size-marker"
    Test-SourceContains ".\flutter\lib\main.dart" "setResizable(false);" "ui:v228-main-window-not-resizable"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_tab_page.dart" "kq-v228-main-window-fixed-size" "ui:v228-tab-switch-keeps-window-fixed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_tab_page.dart" "setResizable(true);" "ui:v228-tab-switch-no-resize-enable"
    Test-SourceContains ".\flutter\lib\common.dart" "mainWindow: type == WindowType.Main" "ui:main-window-restores-with-roomy-floor"
    Test-SourceContains ".\flutter\lib\common.dart" "kLegacyWideMainWindowDefaultWidth = 1360.0" "ui:main-window-migrates-legacy-wide-size"
    Test-SourceContains ".\flutter\lib\common.dart" "kLegacyRoomyMainWindowDefaultWidth = 1120.0" "ui:v221-main-window-migrates-v220-width"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v222-mode-option-consistent-typography" "ui:v222-mode-option-consistent-typography"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\connection_page.dart" "OutlinedButton.icon(" "ui:v222-file-transfer-no-default-button-style"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v222-password-hint-hidden-under-label" "ui:v222-password-hint-hidden-under-label"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v223-password-field-tight-38-height" "ui:v223-password-field-tight-38-height"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v223-password-field-matches-id-font-size" "ui:v223-password-field-matches-id-font-size"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "height: formOnly ? 1.25 : 1.35" "ui:v223-password-field-matches-id-line-height"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v223-password-field-tight-suffix-slot" "ui:v223-password-field-tight-suffix-slot"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "visualDensity: VisualDensity.compact" "ui:v223-password-eye-compact-density"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "constraints: const BoxConstraints.tightFor(width: 32, height: 32)" "ui:v223-password-eye-fixed-button-size"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v223-password-eye-no-extra-padding" "ui:v223-password-eye-no-extra-padding"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v224-file-transfer-mode-selection" "ui:v224-file-transfer-mode-selection"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "bool _connectAsFileTransfer = false" "ui:v224-file-transfer-mode-state"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "void _selectConnectionMode({required bool fileTransfer})" "ui:v224-file-transfer-select-helper"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "onConnect(isFileTransfer: _connectAsFileTransfer)" "ui:v224-connect-uses-selected-mode"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "selected: !_connectAsFileTransfer" "ui:v224-remote-desktop-mutually-exclusive"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "selected: _connectAsFileTransfer" "ui:v224-file-transfer-mutually-exclusive"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\connection_page.dart" "onConnect(isFileTransfer: true);" "ui:v224-file-transfer-option-does-not-connect-immediately"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v224-identical-id-password-inputs" "ui:v224-identical-id-password-inputs"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v224-identical-id-password-input-frame" "ui:v224-identical-id-password-input-frame"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v224-identical-id-password-input-decoration" "ui:v224-identical-id-password-input-decoration"
    Test-SourceMatches ".\flutter\lib\desktop\pages\connection_page.dart" "Widget kqConnectionTextField[\s\S]*return kqConnectionInputFrame" "ui:v224-both-fields-use-same-frame"
    Test-SourceMatches ".\flutter\lib\desktop\pages\connection_page.dart" "Widget kqConnectionTextField[\s\S]*decoration: kqConnectionInputDecoration\(" "ui:v224-both-fields-use-same-decoration"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v225-single-input-component-for-id-and-code" "ui:v225-single-input-component-for-id-and-code"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "Widget kqConnectionTextField({" "ui:v225-shared-input-widget-helper"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v225-trailing-overlay-does-not-affect-textfield-height" "ui:v225-trailing-overlay-does-not-affect-textfield-height"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\connection_page.dart" "suffixIcon:" "ui:v225-no-input-decoration-suffix-icon"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\connection_page.dart" "suffixIconConstraints:" "ui:v225-no-input-decoration-suffix-icon-constraints"
    Test-SourceMatches ".\flutter\lib\desktop\pages\connection_page.dart" "final passwordInput = kqConnectionTextField[\s\S]*return Obx\(\(\) => kqConnectionTextField" "ui:v225-both-fields-use-single-input-component"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v226-empty-id-connect-guard" "ui:v226-empty-id-connect-guard"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v226-password-input-lowercase-formatter" "ui:v226-password-input-lowercase-formatter"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "_passwordController.text.trim().toLowerCase()" "ui:v226-connect-password-normalized-lowercase"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "inputFormatters: [KqLowerCaseTextInputFormatter()]" "ui:v226-password-field-lowercase-display"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v226-connect-button-disabled-grey-blue" "ui:v226-connect-button-disabled-grey-blue"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "disabledBackgroundColor: const Color(0xFFBFD2EA)" "ui:v226-connect-button-grey-blue-color"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "onPressed: canConnect ? _connectWithSelectedMode : null" "ui:v226-connect-button-disabled-when-id-empty"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v229-connect-remember-password-choice" "ui:v229-connect-remember-password-choice-marker"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "bool _rememberPassword = false" "ui:v229-connect-remember-password-state"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "translate('Remember password')" "ui:v229-connect-remember-password-label"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "rememberPassword: _rememberPassword" "ui:v229-connect-passes-remember-password"
    Test-SourceContains ".\flutter\lib\consts.dart" '"kq-remember-connect-password-once"' "ui:v229-connect-remember-password-option"
    Test-SourceContains ".\flutter\lib\common.dart" "rememberPassword = false" "ui:v229-connect-remember-password-param"
    Test-SourceContains ".\flutter\lib\common.dart" "key: kOptionKqRememberConnectPasswordOnce" "ui:v229-connect-writes-remember-password-marker"
    Test-SourceContains ".\flutter\lib\common.dart" "value: rememberPassword ? 'Y' : 'N'" "ui:v229-connect-writes-remember-password-choice"
    Test-SourceContains ".\src\client.rs" "KQ_REMEMBER_CONNECT_PASSWORD_ONCE" "remote:v229-remember-password-marker-consumed"
    Test-SourceContains ".\src\client.rs" "config.options.remove(KQ_REMEMBER_CONNECT_PASSWORD_ONCE)" "remote:v229-remember-password-marker-transient"
    Test-SourceContains ".\src\client.rs" "map(|value| value == `"Y`")" "remote:v229-remember-password-controls-login-config"
    Test-SourceContains ".\flutter\lib\models\server_model.dart" "kq-v226-verification-code-normalize-lowercase" "ui:v226-verification-code-normalize-lowercase"
    Test-SourceContains ".\flutter\lib\models\server_model.dart" "23456789abcdefghijkmnopqrstuvwxyz" "ui:v226-generated-verification-code-lowercase"
    Test-SourceNotContains ".\flutter\lib\models\server_model.dart" "ABCDEFGHJKLMNPQRSTUVWXYZ" "ui:v226-generated-verification-code-no-uppercase"
    Test-SourceMatches ".\flutter\lib\models\server_model.dart" "Future<void> setOneTimePassword[\s\S]*_normalizeVerificationCode\(password\)" "ui:v226-one-time-password-normalized"
    Test-SourceMatches ".\flutter\lib\models\server_model.dart" "Future<void> setDailyPassword[\s\S]*_normalizeVerificationCode\(password\)" "ui:v226-daily-password-normalized"
    Test-SourceMatches ".\flutter\lib\models\server_model.dart" "Future<bool> setPermanentPasswordPreview[\s\S]*_normalizeVerificationCode\(password\)" "ui:v226-permanent-password-normalized"
    ...
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_tab_page.dart" "_KqTitleSettingsButton" "ui:title-settings-gear-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_tab_page.dart" "tail: Offstage(" "ui:title-settings-tail-removed"
    ...
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-home-my-account-entry" "ui:home-sidebar-my-account-entry"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "_buildEmbeddedAccountPane" "ui:home-my-account-embedded-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "class DesktopAccountPage" "ui:account-page-separated-from-settings"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-two-column-workbench" "ui:account-two-column-workbench-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-right-insight-panel" "ui:account-right-insight-panel-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-benefit-checklist" "ui:account-benefit-duplicate-card-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-quick-actions" "ui:account-quick-actions-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-left-column-profile-membership-actions" "ui:account-left-column-profile-membership-actions-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-account-remote-performance-right-panel" "ui:account-remote-performance-right-panel-removed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-reference-page" "ui:v216-account-reference-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-profile-banner" "ui:v216-account-profile-banner"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-member-card" "ui:v216-account-member-card"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-remote-experience-card" "ui:v216-account-remote-experience-card"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-pill-option" "ui:v216-account-pill-option"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-logout-centered" "ui:v216-account-logout-centered"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v216-account-quality-note" "ui:v216-account-quality-note"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "if (!isIncomingOnly) _buildHomeTopBar(context)" "ui:v217-no-duplicate-embedded-titlebar"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v217-account-page-unframed" "ui:v217-account-page-unframed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v217-account-signed-out-reference-panel" "ui:v217-account-signed-out-reference-panel"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v217-account-signed-out-login-action" "ui:v217-account-signed-out-login-action"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v218-settings-reference-shell-unframed" "ui:v218-settings-reference-shell-unframed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-reference-tabs" "ui:v218-settings-reference-tabs"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-common-page" "ui:v218-settings-common-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-safety-page" "ui:v218-settings-safety-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-network-page" "ui:v218-settings-network-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-display-page" "ui:v218-settings-display-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-about-page" "ui:v218-settings-about-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-reference-card" "ui:v218-settings-reference-card"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v218-settings-two-column-checks" "ui:v218-settings-two-column-checks"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v219-home-member-banner-entitlement-aware" "ui:v219-home-member-banner-entitlement-aware"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-v219-account-member-expire-at" "ui:v219-account-member-expire-at"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "memberExpireAt.value.trim()" "ui:v219-account-member-expire-source"
    Test-SourceMatches ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "icon:\s*Icons\.desktop_windows_outlined,\s*label:\s*'1080p'" "ui:v219-member-1080p-no-fixed-lock-icon"
    Test-SourceMatches ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "icon:\s*Icons\.speed_rounded,\s*label:\s*'60 FPS'" "ui:v219-member-60fps-no-fixed-lock-icon"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "SettingsTabKey.printer" "ui:v219-settings-printer-tab-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "_TabInfo(tab, 'Printer'" "ui:v219-settings-printer-label-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "children.add(const _Printer())" "ui:v219-settings-printer-page-removed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v220-saved-connections-fill-empty-space" "ui:v220-saved-connections-fill-empty-space"
    Test-SourceMatches ".\flutter\lib\desktop\pages\desktop_home_page.dart" "Expanded\(\s*// kq-v220-saved-connections-fill-empty-space" "ui:v220-saved-connections-expanded-area"
    Test-SourceNotMatches ".\flutter\lib\desktop\pages\desktop_home_page.dart" "SizedBox\(\s*height:\s*140,\s*child:\s*RecentPeersView\(\)" "ui:v220-saved-connections-not-fixed-one-row"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "translate('Account overview')" "ui:account-no-english-overview-title"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "translate('Membership benefits')" "ui:account-no-english-benefits-title"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "translate('Quick actions')" "ui:account-no-english-quick-actions-title"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "translate('Local account settings')" "ui:account-no-english-local-settings-copy"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "SettingsTabKey.account" "ui:settings-account-tab-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "账户中心" "ui:home-sidebar-account-center-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "class _KqTopBarButton" "ui:home-topbar-action-icons-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "class _KqTopBarTextButton" "ui:home-topbar-return-button-removed"
    ...
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v237-password-required-to-connect" "ui:v237-password-required-to-connect"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "_passwordController.text.trim().isNotEmpty" "ui:v237-password-required-state"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v237-password-change-refreshes-connect-state" "ui:v237-password-change-refreshes-button"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\connection_page.dart" "验证码（可为空）" "ui:v237-password-no-optional-copy"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "kq-v238-password-eye-visual-center" "ui:v238-password-eye-visual-center"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "offset: const Offset(0, -2)" "ui:v238-password-eye-shift-up"
    ...
    Test-SourceContains ".\flutter\lib\desktop\widgets\tabbar_widget.dart" "kq-v235-hide-inert-main-home-tab-keep-drag" "ui:v235-titlebar-home-tab-hidden-keep-drag"
    Test-SourceContains ".\flutter\lib\desktop\widgets\tabbar_widget.dart" "controller.tabType == DesktopTabType.main ||" "ui:v235-titlebar-main-home-tab-hidden"
...
Test-KqAndroidMobileSettingsNo2FA
    ...
    Test-SourceContains ".\flutter\lib\common\widgets\peer_tab_page.dart" "kq-recent-reference-strip" "ui:home-recent-reference-strip-marker"
    Test-SourceNotContains ".\flutter\lib\common\widgets\peer_tab_page.dart" "colors: q.workSurfaceGradient" "ui:home-recent-no-blue-work-surface"
    Test-SourceContains ".\flutter\lib\common\widgets\peers_view.dart" "kq-recent-reference-card-size" "ui:home-recent-reference-card-size"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "_buildKqReferenceRecentCard" "ui:home-recent-reference-card-builder"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kq-recent-reference-card" "ui:home-recent-reference-card-marker"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-home-functional-search-connect" "ui:home-search-field-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "class _KqSearchLikeField" "ui:home-search-widget-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "搜索/连接设备" "ui:home-search-copy-removed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-home-local-summary-no-heading" "ui:home-local-summary-heading-removed"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-home-compact-content-width" "ui:home-compact-content-width"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "class _KqAssistStatusSwitch" "ui:home-local-summary-switch-removed"
    Test-SourceNotContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "class _KqAssistMemberBadge" "ui:home-local-summary-badge-removed"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kq-recent-reference-card-light-blue" "ui:home-recent-card-light-blue-marker"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kq-recent-card-platform-watermark-visible" "ui:home-recent-card-platform-watermark"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kq-recent-card-platform-icon-visible-color" "ui:home-recent-card-platform-icon-visible-color"
    Test-SourceNotContains ".\flutter\lib\common\widgets\peer_card.dart" "Color(0xFF5430D4)" "ui:home-recent-card-no-purple-end"
    Test-SourceNotContains ".\flutter\lib\common\widgets\peer_card.dart" "Color(0xFF5E8BFF)" "ui:home-recent-card-no-purple-start"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "showOnlineStatusFooter" "ui:home-connection-can-hide-online-footer"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "ConnectionPage(showOnlineStatusFooter: false)" "ui:home-hides-online-footer-in-reference-layout"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-settings-reference-shell" "ui:settings-embedded-reference-shell"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-settings-reference-layout" "ui:settings-reference-layout-marker"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-settings-reference-nav-item" "ui:settings-reference-nav-item-marker"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-settings-reference-card" "ui:settings-reference-card-marker"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-desktop-shell" "ui:designer-desktop-shell"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-sidebar" "ui:designer-sidebar"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-header-bar" "ui:designer-header-bar"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-home-member-banner" "ui:designer-home-member-banner"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-local-credential-panels" "ui:designer-local-credential-panels"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-connect-card" "ui:designer-connect-card"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-designer-account-guest-layout" "ui:designer-account-guest-layout"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-designer-account-performance-right" "ui:designer-account-performance-right"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_setting_page.dart" "kq-designer-settings-tabs" "ui:designer-settings-tabs"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-designer-devices-page" "ui:designer-devices-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v214-devices-reference-page" "ui:v214-devices-reference-page"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v214-devices-recent-strip" "ui:v214-devices-recent-strip"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v214-devices-table" "ui:v214-devices-table"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v214-devices-online-refresh" "ui:v214-devices-online-refresh"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v214-devices-connect-action" "ui:v214-devices-connect-action"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v215-devices-account-source" "ui:v215-devices-account-source"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "KqProjectApi.tryFetchAccountDevices()" "ui:v215-devices-fetch-account-devices"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "KqProjectApi.syncCurrentAccountDevice" "ui:v215-devices-sync-current-account-device"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "KqProjectApi.loadCachedAccountDevices()" "ui:v215-devices-load-cached-account-devices"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "KqProjectApi.cacheAccountDevices" "ui:v215-devices-cache-account-devices"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "_handleAccountDeviceOnlineState" "ui:v215-devices-account-online-callback"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v213-reference-home-width-812" "ui:v213-reference-home-width"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v213-login-left-titlebar" "ui:v213-login-left-titlebar"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v213-connect-form-only-card" "ui:v213-connect-form-only-card"
    Test-SourceContains ".\flutter\lib\desktop\pages\desktop_home_page.dart" "kq-v213-saved-connections-header" "ui:v213-saved-connections-header"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "showRecentPeers" "ui:v213-connection-form-toggle"
    Test-SourceContains ".\flutter\lib\common\widgets\peer_card.dart" "kq-v213-recent-white-card" "ui:v213-recent-white-card"
    Test-SourceContains ".\flutter\lib\common\widgets\peers_view.dart" "kq-v213-recent-card-264x140" "ui:v213-recent-card-size"
    ...
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "onConnect(isFileTransfer: _connectAsFileTransfer)" "ui:file-transfer-primary-action"
    Test-SourceContains ".\flutter\lib\desktop\pages\connection_page.dart" "label: translate('Transfer file')" "ui:file-transfer-primary-action-label"
    ...
    Test-SourceContains ".\flutter\lib\common\kq_oauth_io.dart" "kq-v236-windows-oauth-shell-browser-fallback" "login:v236-windows-shell-browser-fallback"
    Test-SourceContains ".\flutter\lib\common\kq_oauth_io.dart" "Process.run('cmd'" "login:v236-windows-cmd-start-fallback"
    Test-SourceContains ".\flutter\lib\common\kq_oauth_io.dart" "start" "login:v236-windows-start-command"
    Test-SourceContains ".\flutter\lib\common\kq_oauth_io.dart" "Twinkstar" "login:v236-twinkstar-browser-candidate"
    Test-SourceContains ".\flutter\lib\common\kq_oauth_io.dart" "twinkstar.exe" "login:v236-twinkstar-browser-exe"
