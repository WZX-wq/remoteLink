...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Basic plan", "基础版"),
        ("Member plan", "会员版"),
        ("Members can switch between 720p / 1080p and 30 / 60 FPS.", "会员可在 720p / 1080p 与 30 / 60 FPS 间切换。"),
        ...
        ("Membership unlocks 1080p / 60 FPS. Free users keep 720p / 30 FPS.", "会员解锁 1080p / 60 FPS，免费用户保留 720p / 30 FPS。"),
        ("Payment method", "支付方式"),
        ("WeChat QR", "微信扫码"),
        ("WeChat Pay", "微信支付"),
        ("Alipay", "支付宝"),
        ...
        ("Upgrade to unlock 1080p and 60 FPS", "当前账号最多可用 720p / 30 FPS，开通会员后可使用 1080p / 60 FPS。"),
    ].iter().cloned().collect();
}
