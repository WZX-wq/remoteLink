...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Basic plan", "基础版"),
        ("Member plan", "会员版"),
        ("Members can switch between 720p / 1080p and 30 / 60 FPS.", "会员可在 720p 标清与 1080p 高清间切换，两档均使用稳定 60 FPS 视频链路。"),
        ("Members can use 720p / 60 FPS or 1080p / 60 FPS.", "会员可使用 720p / 60 FPS 标清或 1080p / 60 FPS 高清两档。"),
        ("Basic plan uses 720p / 60 FPS. Members can use 1080p / 60 FPS.", "基础版使用 720p / 60 FPS 标清，会员可使用 1080p / 60 FPS 高清。"),
        ("Basic plan supports up to 720p / 30 FPS. Members can use 1080p / 60 FPS.", "会员畅享专属加速链路"),
        ...
        ("Members can use 1080p / 60 FPS", "开通会员后可使用 1080p / 60 FPS"),
