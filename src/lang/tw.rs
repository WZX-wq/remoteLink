...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Membership unlocks 1080p / 60 FPS. Free users keep 720p / 30 FPS.", "會員解鎖 1080p / 60 FPS，免費使用者保留 720p / 30 FPS。"),
        ("Pay now", "立即支付"),
        ...
        ("HD quality", "高畫質"),
        ("Members only", "會員專屬"),
        ("Membership quality unlocked", "會員畫質已解鎖，可使用 1080p 和 60 FPS。"),
        ("Upgrade to unlock 1080p and 60 FPS", "目前帳號最多可用 720p / 30 FPS，開通會員後可使用 1080p / 60 FPS。"),
