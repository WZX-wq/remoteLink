...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("printer-os-requirement-tip", "Pro sa funtzionalidade de imprenta in essida b'at bisòngiu de Windows 10 o prus nou."),
        ("printer-requires-installed-{}-client-tip", "Pro pòdere impreare s'imprentadora in seddida bisòngiat a installare {} in custu dispositivu."),
