  ...
  if (isDesktop) {
    ...
    if (isFileTransfer) {
      ...
      if (isWeb) {
        ...
        gFFI.mobileRemoteRoute = remoteRoute;
        unawaited(Navigator.push<void>(context, remoteRoute).then((_) {
          if (identical(gFFI.mobileRemoteRoute, remoteRoute)) {
            gFFI.mobileRemoteRoute = null;
          }
        }));
      }
    }
